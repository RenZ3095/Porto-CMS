...
export default function ProjectsPage() {
  const { projects, loading, error } = useProjectsQuery();

  return (
    <div className="mx-auto max-w-6xl px-6 pb-16 pt-10 md:px-10 md:pt-14">
      <Seo
        title="Projects"
        description="Selected portfolio projects with case studies, technology stacks, and outcomes."
        path="/projects"
      />

      <p className="text-xs uppercase tracking-[0.24em] text-cyan-200/80">Selected Work</p>
      <h2 className="mt-2 font-display text-4xl font-semibold md:text-5xl">Projects</h2>
      <p className="mt-4 max-w-2xl text-slate-300">
        A focused collection of projects that show how I learn, build, and improve digital products through real implementation.
      </p>
